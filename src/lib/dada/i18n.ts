...
export const DICT: Record<LangCode, Dict> = {
  en: {
    tagline: "MANIFESTO GENERATOR · NO L.L.M. · ONLY CHANCE",
    prompt: "Give me your words. I will fracture them.",
    ...
    footR: "COMPOSED FROM YOUR WORDS · CORRUPTED BY CHANCE",
    manifesto: "MANIFESTO",
    edition: "Manifesto N°",
    seed: "SEED",
  ...
  es: {
    tagline: "GENERADOR DE MANIFIESTOS · SIN L.L.M. · SOLO AZAR",
    prompt: "Dame tus palabras. Las voy a romper.",
    ...
    footR: "COMPUESTO CON TUS PALABRAS · CORROMPIDO POR EL AZAR",
  ...
  it: {
    tagline: "GENERATORE DI MANIFESTI · SENZA L.L.M. · SOLO CASO",
    prompt: "Dammi le tue parole. Le frantumerò.",
    ...
    footR: "COMPOSTO DALLE TUE PAROLE · CORROTTO DAL CASO",
    manifesto: "MANIFESTO",
    edition: "Manifesto N°",
    seed: "SEME",
  ...
  pt: {
    tagline: "GERADOR DE MANIFESTOS · SEM L.L.M. · SÓ ACASO",
    prompt: "Dê-me as suas palavras. Vou parti-las.",
    ...
    footL: "RECORTE DE TZARA · 1920",
    footR: "COMPOSTO COM AS TUAS PALAVRAS · CORROMPIDO PELO ACASO",
    manifesto: "MANIFESTO",
    edition: "Manifesto N°",
    seed: "SEMENTE",
  ...
  fr: {
    tagline: "GÉNÉRATEUR DE MANIFESTES · SANS L.L.M. · TOUT EST HASARD",
    prompt: "Donne-moi tes mots. Je vais les briser.",
    ...
    footR: "COMPOSÉ DE TES MOTS · CORROMPU PAR LE HASARD",
    manifesto: "MANIFESTE",
    edition: "Manifeste N°",
    seed: "GRAINE",
  ...
  ar: {
    tagline: "مولِّد البيانات · بلا ذكاء اصطناعي · فقط الصدفة",
    prompt: "أعطني كلماتك. سأحطّمها.",
    ...
    footR: "مُؤلَّف من كلماتك · مُفسَد بالصدفة",
    manifesto: "بيان",
    edition: "بيان رقم",
    seed: "بذرة",
  ...
  zh: {
    tagline: "宣言生成器 · 拒绝大模型 · 唯有偶然",
    prompt: "把你的字给我。我会把它们撕碎。",
